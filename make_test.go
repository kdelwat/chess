...
func TestMakeUnmake(t *testing.T) {
	cases := []testMove{
		...
		{"Promotion", "rnbq1bnr/pppBP1p1/6kp/5p2/3Q4/8/PPP2PPP/RNB1K1NR w KQ - 0 9", "rnbqQbnr/pppB2p1/6kp/5p2/3Q4/8/PPP2PPP/RNB1K1NR b KQ - 1 9", createPromotionMove(100, 116, Queen)},
	}
